...
- `2026-08-28_1814_combat-vfx-role-samples.md`: 灰谷演武台新增骑兵二连跃、法师流星火雨、牧师神圣庇护三场信号驱动表现样片；职业专属轮廓、自动关注和静态／模拟回归已接通，按用户要求未做网页视觉验收。

## 2026-08-24

- `2026-08-24_1637_difficulty-six-three-role-focus.md`: 第6层由五职业12人收束为2骑士＋4法师＋2牧师的8人盾法牧阵；高法抗史诗克制队50/50，关卡只保留三种敌方职业。
- `2026-08-24_1620_difficulty-six-fixed-counter-formation.md`: 第6层改为固定2守卫/3法师/3术士/2炼金/2牧师的源心法阵；高法抗史诗克制队50/50，低法抗史诗劣势队0/50，套装从必要门槛改为可选捷径。
- `2026-08-24_1606_difficulty-six-epic-gear-gate.md`: 第6层“魔潮源心”校准为真实装备毕业考试；50局中全员史诗无套装24%，战士/骑兵史诗六件套70%/60%，单人8件传说无套装56%，并公开推荐水位而非硬检测放行。
- `2026-08-24_1548_sixth-grind-tier-and-set-drops.md`: 史诗及以上讨伐装备每件20%转正式套装；450分解锁第6层，固定3件且品质20/42/30/8；三槽定向池限制套装范围，600件史诗样本实测21.0%并完成真实六件套激活。
- `2026-08-24_1415_cavalry-event-wall-priest-range.md`: 第3日新增事件招募正式马骑兵；叹息之墙拦奔跑／冲锋／突破但放行二连跃；牧师支援统一限制为42距离，专项与灰谷回归均通过。
- `2026-08-24_1341_cavalry-4v4-role-substitution.md`: 现有17套4v4预设逐槽替换基础骑兵，共68变体、9,248场；强度槽位最接近战士但约35%对局分类改变，与狂战士、法师、术士差异显著，未发现完全重复定位。
- `2026-08-24_1324_cavalry-counter-factor-ablation.md`: 消融证明治疗不是克制骑兵的必要条件：无套装`10盾10法`仍有90%，而`10盾10牧`为0%；关键是骑士基础控制防护配合法师击杀压力。
- `2026-08-24_1241_cavalry-counter-team-matrix.md`: 当前20v20骑兵队的盾牧法克制矩阵；无套装`8盾2牧10法`胜率96%，全套装`10盾2牧8法`胜率94%，`8盾4牧8法`两档88%/90%最稳定；极端堆盾和盾牧游均不成立。

## 2026-08-22

- `2026-08-22_1715_cavalry-run-three-distance-balance.md`: 奔跑震击间隔6→3；无套装完整奔跑6次、全套装7次。当前无骑士演武各50局中骑兵输出占比约21%—29%，全套装约38%—43%；同种子单骑伤害提高约17.5%—31.2%，全套装20v20胜率98%。
- `2026-08-22_1658_cavalry-run-distance-pulses.md`: 马骑兵奔跑0.8→1.2秒；每6真实移动距离对8范围造成`12+0.3×物攻`AOE，并对每名目标独立20%概率眩晕0.6秒；全套装完整奔跑22.5距离、3次震击并自然蓄满冲锋，专项/网页静态回归通过。
- `2026-08-22_1622_focused-unit-skill-feed.md`: 灰谷战斗新增顶部手动开战、可切换/取消的单位关注光圈，以及按左右阵营侧滑的技能与低频关键效果提示；连续刷装仍自动，静态与骑兵冲锋回归通过，按用户要求未做网页视觉验证。
- `2026-08-22_1554_cavalry-base-and-charge-speed.md`: 马骑兵基础移速18→12，冲锋就绪改为当前移速1.5倍；六件套常态15、冲锋22.5，演示1.12秒蓄势、2.56秒突破，三档全套装仍100%至少蓄势一次。
- `2026-08-22_1524_cavalry-charge-distance-demo.md`: 灰谷演武台新增1名六件套马骑兵对静止零攻击木桩的冲锋演示；战场下沿以出生点为0显示每4距离刻度、实时连续进度和16门槛，权威战斗在0.72秒蓄势、1.92秒突破。
- `2026-08-22_1512_cavalry-charge-threshold-sensitivity.md`: 全套装4v4/8v8/20v20对16/20/24/28门槛各跑50场；16档所有骑兵0.72秒内蓄满且停步重置几乎无效，24是温和上调候选，28更强调后续拉扯与奔跑。
- `2026-08-22_1456_cavalry-continuous-movement-charge.md`: 奔袭铁骑六件套改为同一段连续移动累计16距离；停步0.4秒清空未完成进度，二连跃两跳保持同一移动链，已经蓄满的冲锋就绪不因停步消失。
- `2026-08-22_1443_run-natural-distance-charge-correction.md`: 撤销奔跑施放即蓄势的错误特殊联动；保留0.8秒短冲，所有真实移动统一累计，奔袭铁骑六件套仅在累计距离跨过16后自然进入冲锋就绪。
- `2026-08-22_1435_short-run-arms-cavalry-charge.md`: 马骑兵奔跑由2.8秒缩至0.8秒并正确吃套装移速；六件套施放时直接进入冲锋就绪，网页蓄势统计排除击杀被动假计数。
- `2026-08-22_1419_knightless-cavalry-training-lineup.md`: 骑兵无套装/全套装4v4、8v8、20v20双方均移除骑士，以战士替换；嘲讽与叹息之墙截断归零，全套装8v8固定样本形成4次冲锋命中。
- `2026-08-22_1200_global-nearest-visible-targeting.md`: 共享战斗11职业默认选敌统一为最近可见敌人；移除近战前排优先与刺客普通AI最低血特例，保留嘲讽、强制锁定及技能明确目标规则。
- `2026-08-22_1156_cavalry-nearest-visible-charge-target.md`: 骑兵移动类动作从近战前排优先改为最近可见目标；奔跑、乘胜冲锋、二连跃和套装突破朝向统一，保留嘲讽与强制锁定优先级。
- `2026-08-22_1151_cavalry-double-leap-sight-gate.md`: 修正二连跃开场预知远端目标；敌人进入31距离且可见后才释放，等待期间不消耗CD，三档演武及共享战斗回归通过。
- `2026-08-22_1127_cavalry-warrior-attack-range.md`: 马骑兵攻击距离由20降至13并与战士绑定；奔跑普攻说明和浏览器资产同步，冲锋、套装及三档演武回归通过。
- `2026-08-22_1109_full-set-cavalry-training-ground.md`: 灰谷演武台新增全员六件套4v4/8v8/20v20；双方逐单位应用正式职业套装，战报增加骑兵冲锋蓄势、突破、命中、伤害与截断统计，并补充冲锋可视反馈。
- `2026-08-22_1050_mock-battles-normal-speed.md`: 灰谷全部演武战斗由3倍改为1倍普通速度；骑兵4v4/8v8/20v20及繁生之环A/B均生效，正式玩法和连续讨伐速度不变。
- `2026-08-22_1034_role-vfx-filter-cavalry-default.md`: 共享战斗新增按职业过滤技能名、飘字与光效的运行时开关；灰谷战斗HUD可选全部/关闭/当前职业，马骑兵演武默认只显示骑兵特效，战斗指纹回归一致。
- `2026-08-22_0142_cavalry-training-ground-web.md`: 将灰谷原套装演武场扩为通用演武台，新增马骑兵4v4/8v8/20v20无套装共享战斗入口与输出占比、生存、击杀、存活专项战报；代码级验证通过，按用户要求留待其自行网页验收。

## 2026-08-21

- `2026-08-21_2357_cavalry-role-and-no-set-scale-test.md`: 实装马骑兵与18/10/35秒四技能；无套装各50局4v4/8v8/20v20中贡献27.69%/25.56%/25.14%团队输出，平均生存27.71/31.70/12.61秒，技能低频但强，20v20亲手击杀占比较低。
- `2026-08-21_2318_move-speed-attribute-and-cavalry-draft.md`: 将共享战斗写死移速升级为职业一级属性；老职业保持7、刺客保持10，骑兵确认移速18、射程20并记录完整基础档位，四技能仍待用户设计。
- `2026-08-21_2258_magic-resistance-team-smoke-test.md`: 固定双法师主C队并隔离覆盖敌方0/3/6/9魔抗；高法抗相较低法抗令法师DPS下降约6.7%—11.3%，在接近均势或续航对局中使法师队胜率下降约15个百分点。
- `2026-08-21_2240_mage-base-magic-resistance.md`: 法师基础魔抗由2调整为中法抗6；专项、游戏数据与火雨套回归通过，骑兵不动。
- `2026-08-21_2151_role-base-magic-resistance-tiers.md`: 将低/中/高/无法抗统一为3/6/9/0；按用户要求重分九个职业基础魔抗，法师暂留2，骑兵不动，专项、套装和灰谷回归通过。
