...
assert(web.includes("function renderWorldUnits") && web.includes("current.party.heroes.map") && web.includes("current.party.militiaUnits.map") && web.includes("HERO_WORLD_POSITIONS") && !web.includes("TRAINED_WORLD_POSITIONS"), "Simplified world layer should show owned heroes and militia without duplicating trained-unit scenery");
...
assert(web.includes("const PLOT_POSITIONS = [[430, 520], [295, 650], [570, 690], [835, 680], [1060, 560], [1020, 405], [865, 300]]") && web.includes("const MILITIA_WORLD_POSITIONS = [[620, 500], [675, 500], [730, 500], [785, 500]"), "Simplified node layout no longer reserves a clean central militia assembly area");
