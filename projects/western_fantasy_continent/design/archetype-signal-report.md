...
| `crownCarry` 王冠核心 | basicAttack | needs work | 6/7 | poisonBloom, shadowExecute |
...
- PASS [curve] `payoffCycles`: 12.625 >= 1
- PASS [metric] `statusStacksApplied`: 53.563 >= 20
- PASS [metric] `statusPayoffDamageShare`: 0.260 >= 0.120
- PASS [failure boundary] `poisonStacksApplied`: 30 >= 4
- PASS [failure boundary] `burnStacksApplied`: 23.563 >= 4
...
- Samples: 16
- PASS [curve] `highHealthDecline`: 0.574 >= 0.300
- PASS [curve] `lowHealthSurvivalSeconds`: 10.150 >= 3
- PASS [curve] `lowHealthOscillations`: 6.500 >= 1
- PASS [curve] `postLowAttackRateRatio`: 2.531 >= 1.200
- PASS [curve] `recoveryAfterLow`: 0.219 >= 0.080
- PASS [metric] `basicDamageShare`: 0.926 >= 0.450
- PASS [metric] `empoweredBasicDamageShare`: 0.828 >= 0.300
- PASS [metric] `healingPerSecond`: 20.538 >= 1
...
- Samples: 16
- PASS [curve] `carryBuffShare`: 0.698 >= 0.450
- PASS [metric] `basicDamageShare`: 1 >= 0.280
- PASS [metric] `hasteWindowBasicDamageShare`: 0.687 >= 0.100
- PASS [metric] `shieldPerSecond`: 20.556 >= 3
- PASS [failure boundary] `carrySurvives10Seconds`: 1 >= 0.750
- PASS [failure boundary] `carryDamageShare`: 0.779 >= 0.450
- FAIL [failure boundary] `carryDamageShare`: 0.779 <= 0.750
...
- Samples: 16
- PASS [curve] `peak2sDamageShare`: 0.429 >= 0.200
- PASS [curve] `postPeakDamageRateRatio`: 0.351 <= 0.750
- PASS [curve] `burnCoverageBeforeUltimate`: 1 >= 0.500
- PASS [metric] `burnStacksApplied`: 29.688 >= 12
- PASS [metric] `ultimateDamageShare`: 0.172 >= 0.120
- PASS [metric] `areaDamageShare`: 0.403 >= 0.200
...
- PASS [metric] `enemyMeleeBasicPerSecond`: 0.453 <= 1.800
- PASS [metric] `statusPayoffDamageShare`: 0.210 >= 0.050
...
- Samples: 16
- PASS [curve] `teamRecoveryAfterCrisis`: 0.172 >= 0.100
- PASS [metric] `healingPerSecond`: 23.458 >= 5
- PASS [metric] `shieldPerSecond`: 46.005 >= 4
- PASS [metric] `effectiveHealingRatio`: 0.866 >= 0.600
- PASS [metric] `survivorsAt20Seconds`: 2.438 >= 2
- PASS [failure boundary] `teamRecoveryAfterCrisis`: 0.172 <= 0.550
...
- PASS [curve] `postUltimateHpLossRatio`: 0.261 <= 0.800
- PASS [metric] `counterTriggers`: 8.063 >= 1
- PASS [metric] `counterDamageShare`: 0.141 >= 0.060
- PASS [metric] `counterDamageShare`: 0.141 <= 0.180
- PASS [metric] `shieldPerSecond`: 30.995 >= 3
...
- Samples: 16
- PASS [curve] `topTwoBuffShare`: 0.659 >= 0.550
- PASS [metric] `markApplications`: 6.625 >= 6
- PASS [metric] `hasteWindowBasicDamageShare`: 0.266 >= 0.120
- PASS [metric] `basicDamageShare`: 0.414 >= 0.200
- PASS [failure boundary] `lowestTargetDamageShare`: 0.365 >= 0.350
...
- Samples: 16
- PASS [curve] `poisonApplicationAcceleration`: 2.423 >= 1.150
- PASS [curve] `poisonSpreadEvents`: 6 >= 0.500
- PASS [curve] `payoffCycles`: 1.063 >= 1
- PASS [metric] `poisonStacksApplied`: 66.313 >= 12
- PASS [metric] `dotDamageShare`: 0.329 >= 0.200
- PASS [metric] `dotDamageShare`: 0.329 <= 0.550
- PASS [metric] `statusPayoffDamageShare`: 0.185 >= 0.080
- PASS [failure boundary] `payoffStartsAfterSetup`: 1 >= 1
...
- Samples: 16
- PASS [curve] `peak2sDamageShare`: 0.221 >= 0.160
- PASS [metric] `executeDamageShare`: 0.259 >= 0.100
- PASS [metric] `lowestTargetDamageShare`: 0.341 >= 0.250
- PASS [metric] `selfCostPerSecond`: 1.993 >= 0.200
- PASS [failure boundary] `areaDamageShare`: 0.031 <= 0.500
