(() => {
  ...
  const SAVE_KEY = "agent_automata_equipment_grind_v2_three_wave";
  ...
  const DUNGEONS = [
    { level: 1, name: "旧路鼠窟", icon: "●", power: 2600, enemyPoints: 0, enemyGear: 0, rewardTier: "18-28", itemLevelRange: [18, 28], rarity: { common: 0.86, rare: 0.135, epic: 0.005 }, dropCount: 7, enemySets: [["warrior", "warrior", "ranger", "priest"], ["knight", "warrior", "mage", "ranger"], ["berserker", "warrior", "priest", "bard"]] },
    { level: 2, name: "黑松哨站", icon: "◆", power: 6500, enemyPoints: 4, enemyGear: 28, rewardTier: "26-42", itemLevelRange: [26, 42], rarity: { common: 0.7, rare: 0.285, epic: 0.015 }, dropCount: 7, enemySets: [["knight", "warrior", "mage", "priest"], ["warrior", "berserker", "ranger", "bard"], ["assassin", "knight", "warlock", "priest"]] },
    { level: 3, name: "腐火地窟", icon: "●", power: 8500, enemyPoints: 8, enemyGear: 60, rewardTier: "38-64", itemLevelRange: [38, 64], rarity: { common: 0.37, rare: 0.48, epic: 0.135, legendary: 0.015 }, dropCount: 8, enemySets: [["knight", "mage", "mage", "priest"], ["warrior", "alchemist", "warlock", "bard"], ["assassin", "assassin", "knight", "ranger"]] },
    { level: 4, name: "王墓外环", icon: "◆", power: 11500, enemyPoints: 12, enemyGear: 100, rewardTier: "58-84", itemLevelRange: [58, 84], rarity: { rare: 0.54, epic: 0.38, legendary: 0.075, mythic: 0.005 }, dropCount: 6, enemySets: [["knight", "knight", "priest", "ranger"], ["warrior", "berserker", "mage", "bard"], ["assassin", "warlock", "alchemist", "priest"]] },
    { level: 5, name: "龙骨浅层", icon: "●", power: 14500, enemyPoints: 18, enemyGear: 155, rewardTier: "80-120", itemLevelRange: [80, 120], rarity: { rare: 0.16, epic: 0.53, legendary: 0.28, mythic: 0.03 }, dropCount: 8, enemySets: [["knight", "warrior", "mage", "priest"], ["berserker", "assassin", "ranger", "bard"], ["warlock", "alchemist", "mage", "knight"]] },
    { level: 6, name: "灰冠深井", icon: "◆", power: 18000, enemyPoints: 26, enemyGear: 225, rewardTier: "102-136", itemLevelRange: [102, 136], rarity: { epic: 0.56, legendary: 0.38, mythic: 0.06 }, dropCount: 6, enemySets: [["knight", "warrior", "warlock", "priest"], ["berserker", "knight", "mage", "bard"], ["assassin", "ranger", "alchemist", "priest"]] },
    { level: 7, name: "星坠祭坛", icon: "●", power: 22000, enemyPoints: 36, enemyGear: 310, rewardTier: "126-166", itemLevelRange: [126, 166], rarity: { epic: 0.26, legendary: 0.53, mythic: 0.21 }, dropCount: 8, enemySets: [["knight", "knight", "mage", "priest"], ["warrior", "berserker", "warlock", "bard"], ["assassin", "assassin", "ranger", "alchemist"]] },
    { level: 8, name: "夜王门厅", icon: "◆", power: 26500, enemyPoints: 48, enemyGear: 420, rewardTier: "148-178", itemLevelRange: [148, 178], rarity: { epic: 0.1, legendary: 0.58, mythic: 0.32 }, dropCount: 6, enemySets: [["knight", "warrior", "mage", "priest"], ["berserker", "assassin", "warlock", "bard"], ["knight", "alchemist", "mage", "ranger"]] },
    { level: 9, name: "无月王冠", icon: "●", power: 31500, enemyPoints: 62, enemyGear: 540, rewardTier: "170-198", itemLevelRange: [170, 198], rarity: { legendary: 0.46, mythic: 0.54 }, dropCount: 6, enemySets: [["knight", "berserker", "mage", "priest"], ["warrior", "assassin", "warlock", "bard"], ["knight", "alchemist", "mage", "ranger"]] },
  ];
