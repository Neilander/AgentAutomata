...
const stateDir = path.join(experimentDir, "state_attempt_2026082814_v14");
...
try {
  ...
  // Keep malformed output as raw evidence and let the verifier fail strictly.
}
