...
const dir = __dirname;
const stateDir = path.join(dir, "state_attempt_2026082918_v18");
const profile = path.join(dir, "player-v18-fresh.json");
...
fs.appendFileSync(ledger, `${JSON.stringify({
  ...
  attentionSeed: seed,
  playerProfile: "player-v18-fresh.json",
