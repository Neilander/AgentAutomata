# V19 isolated-player live-play protocol
...
- Construct every payload from the matching public `operationContracts` entry. It lists all required fields and their fixed values, public candidates, or numeric bounds; do not guess alternate field names.
