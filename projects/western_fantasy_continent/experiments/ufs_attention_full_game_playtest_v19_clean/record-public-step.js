...
const dir = __dirname;
const stateDir = path.join(dir, "state_attempt_2026082919_v19");
const profile = path.join(dir, "player-v19-fresh.json");
...
fs.appendFileSync(ledger, `${JSON.stringify({
  ...
  attentionSeed: seed,
  playerProfile: "player-v19-fresh.json",
