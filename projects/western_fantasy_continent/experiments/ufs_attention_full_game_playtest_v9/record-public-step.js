...
const stateDir = path.join(experimentDir, "state_attempt_2026082509_v9");
...
try {
  ...
  // The ledger still preserves process failure metadata and exact output.
}
